...
import com.example.vitesse.databinding.FragmentAddBinding // Update with your actual package name
...
class AddFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        db = Room.databaseBuilder(
            requireContext(),
            AppDatabase::class.java, "candidat_database"
        ).build()
        ...
        if (isValid) {
            ...
            lifecycleScope.launch {
                try {
                    ...
                    Log.d("AddFragment", "Candidat inserted locally: $candidate")

                    // Optionally save remotely
                    // remoteViewModel.addCandidatToApi(candidate)

                    Log.d("AddFragment", "Candidat saved remotely")

                    showToast(getString(R.string.added_canidate_success))
                    findNavController().navigate(R.id.homePageFragment)
                } catch (e: Exception) {
                    Log.e("AddFragment", "Error saving candidat: ${e.message}")
                }
            }
        } else {
            Log.w("AddFragment", "All fields must be valid")
        }
    }
    ...
    override fun onDestroyView() {
        super.onDestroyView()
        _binding = null
        Log.d("AddFragment", "onDestroyView called")
    }
}